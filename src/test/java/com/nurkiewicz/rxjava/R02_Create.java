...
*/
    ...
    public void infiniteObservable() throws Exception {
        Observable<Integer> obs = Observable.create(sub -> {
            int i = 0;
            //el isDisposed nos dice si ya no hay subscripciones
            // si no, aunque el observador solo toma 3 elementos el observable continua indefinidamente
            //y como estamos en el mismo hilo, la app se bloquea
